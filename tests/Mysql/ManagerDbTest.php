...
class ManagerDbTest extends TestCase
{
    ...
    {
        $conn1 = ORM::instance()->getDoctrineConnectionByUrl($_ENV['DB_MYSQL_DB1']);
        self::$dbHelper = new DbHelper( $conn1 );

        $conn2 = ORM::instance()->getDoctrineConnectionByUrl($_ENV['DB_MYSQL_DB2']);
    ...
    protected function setUp(): void
    {
        ...
        self::$dbHelperChange->resetTo('Mysql/fixtures/fix.sql');
...
//    }
    ...
    public function testChangeDb()
    {
        ...
        $connectionParams = (new DsnParser())->parse($_ENV['DB_MYSQL_DB2']);
    ...
    public function testTwoMgrsForSameEntityWithDiffDbs()
    {
        ...
        $mgr2 = $orm->entityManager(OrmTest\Manager::class, $orm->getDoctrineConnectionByUrl($_ENV['DB_MYSQL_DB2']));
