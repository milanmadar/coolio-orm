...
class MultiCurveZTest extends TestCase
{
    public function testSTGeomFromEWKTSimple()
    {
        ...
        $expected = "ST_GeomFromEWKT('SRID=4326;MULTICURVE Z(CIRCULARSTRING Z(0.00000000 0.00000000 4.00000000,1.00000000 2.00000000 4.00000000,2.00000000 0.00000000 4.00000000),LINESTRING Z(3.00000000 3.00000000 4.00000000,4.00000000 4.00000000 4.00000000,5.00000000 5.00000000 4.00000000))')";
    ...
    public function testSTGeomFromEWKTComplex()
    {
        ...
        $expected = "ST_GeomFromEWKT('SRID=4326;MULTICURVE Z(CIRCULARSTRING Z(0.00000000 0.00000000 0.00000000,2.00000000 0.00000000 0.00000000,2.00000000 2.00000000 0.00000000,0.00000000 2.00000000 0.00000000,0.00000000 0.00000000 0.00000000),LINESTRING Z(3.00000000 3.00000000 0.00000000,5.00000000 5.00000000 0.00000000),COMPOUNDCURVE Z(LINESTRING Z(6.00000000 6.00000000 0.00000000,7.00000000 7.00000000 0.00000000),CIRCULARSTRING Z(7.00000000 7.00000000 0.00000000,8.00000000 8.00000000 0.00000000,9.00000000 7.00000000 0.00000000)))')";
        $this->assertSame($expected, $multiCurve->ST_GeomFromEWKT());
    }
