...
class GeometryCollectionTest extends TestCase
{
    public function testSTGeomFromEWKTSimple()
    {
        ...
        $expected = "ST_GeomFromEWKT('SRID=4326;GEOMETRYCOLLECTION(POINT(1.00000000 1.00000000),LINESTRING(2.00000000 2.00000000,3.00000000 3.00000000,4.00000000 4.00000000))')";
    ...
    public function testSTGeomFromEWKTComplex()
    {
        ...
        $expected = "ST_GeomFromEWKT('SRID=4326;GEOMETRYCOLLECTION(POINT(1.00000000 1.00000000),LINESTRING(2.00000000 2.00000000,3.00000000 3.00000000,4.00000000 4.00000000),POLYGON((0.00000000 0.00000000,5.00000000 0.00000000,5.00000000 5.00000000,0.00000000 5.00000000,0.00000000 0.00000000),(1.00000000 1.00000000,1.00000000 2.00000000,2.00000000 2.00000000,2.00000000 1.00000000,1.00000000 1.00000000)))')";
        $this->assertSame($expected, $geometryCollection->ST_GeomFromEWKT());
    }
