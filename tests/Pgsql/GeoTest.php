...
class GeoTest extends TestCase
{
    ...
    public function testgetSQLNamedParameters()
    {
        ...
        $expect = "SELECT geometry_test.id, ST_AsEWKT(geometry_test.point_geom) AS point_geom, ST_AsEWKT(geometry_test.linestring_geom) AS linestring_geom, ST_AsEWKT(geometry_test.polygon_geom) AS polygon_geom, ST_AsEWKT(geometry_test.multipoint_geom) AS multipoint_geom, ST_AsEWKT(geometry_test.multilinestring_geom) AS multilinestring_geom, ST_AsEWKT(geometry_test.multipolygon_geom) AS multipolygon_geom, ST_AsEWKT(geometry_test.geomcollection_geom) AS geomcollection_geom, ST_AsEWKT(geometry_test.circularstring_geom) AS circularstring_geom, ST_AsEWKT(geometry_test.compoundcurve_geom) AS compoundcurve_geom, ST_AsEWKT(geometry_test.curvedpolygon_geom) AS curvedpolygon_geom, ST_AsEWKT(geometry_test.multicurve_geom) AS multicurve_geom FROM public.geometry_test WHERE 1=1 LIMIT 1";
