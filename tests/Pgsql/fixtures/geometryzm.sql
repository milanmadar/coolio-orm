...
CREATE TABLE geometryzm_test (
  ...
  curvepolygonzm_geom      geometry(CurvePolygonZM, 4326),
...
INSERT INTO geometryzm_test (
    ...
    ST_GeomFromEWKT('SRID=4326;POLYGON ZM((0 0 0 98, 0 5 0 98,5 5 0 98,5 0 0 98,0 0 0 98))'),
    ST_GeomFromEWKT('SRID=4326;MULTIPOINT ZM((1 1 1 100),(2 2 2 100),(3 3 3 100))'),
    ST_GeomFromEWKT('SRID=4326;MULTILINESTRING ZM((0 0 0 99,1 1 1 99),(2 2 2 99,3 3 3 99))'),
    ST_GeomFromEWKT('SRID=4326;MULTIPOLYGON ZM(((0 0 0 101,0 3 0 100,3 3 0 100,3 0 0 100,0 0 0 101)),((4 4 4 102,4 6 4 100,6 6 4 100,6 4 4 100,4 4 4 102)))'),
