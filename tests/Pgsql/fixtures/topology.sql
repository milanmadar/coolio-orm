...
INSERT INTO public.topology_test (
 ...
 'Main Street',
 toTopoGeom(
         ST_GeomFromText('MULTIPOINT(1 2)', 4326), -- your raw geometry
 ...
 toTopoGeom(
         ST_GeomFromText('MULTILINESTRING((1 2, 3 4))', 4326), -- your raw geometry
         'topology_test_topo',                          -- topology schema
         2,                                             -- topology layer id (typically 1 if only 1 layer)
         0.001                                          -- tolerance for snapping and validation
 ),
 toTopoGeom(
         ST_GeomFromText('MULTIPOLYGON(((0 0,0 5,5 5,5 0,0 0),(1 1,1 2,2 2,2 1,1 1)))', 4326), -- your raw geometry
         'topology_test_topo',                           -- topology schema
         3,                                              -- topology layer id (typically 1 if only 1 layer)
         0.001                                           -- tolerance for snapping and validation
 ),
 toTopoGeom(
         ST_GeomFromText('GEOMETRYCOLLECTION(POINT(1 1),LINESTRING(2 2,3 3,4 4))', 4326), -- your raw geometry
         'topology_test_topo',                                -- topology schema
