...
class GeoZTest extends TestCase
{
    ...
    public function testInsert_asObjects()
    {
        ...
        $mgr->createQueryBuilder()
            ->insert()
            ->setGeom('pointz_geom', $pointZ)
            ->setGeom('linestringz_geom', $lineStringZ)
            ->setGeom('polygonz_geom', $polygonZ)
            ->setGeom('multipointz_geom', $multiPointZ)
            ->setGeom('multilinestringz_geom', $multiLineStringZ)
            ->setGeom('multipolygonz_geom', $multiPolygonZ)
            ->setGeom('geomcollectionz_geom', $geometryCollectionZ)
            ->setGeom('circularstringz_geom', $circularStringZ)
            ->setGeom('compoundcurvez_geom', $compoundCurveZ)
            ->setGeom('curvedpolygonz_geom', $curvePolygonZ)
            ->setGeom('multicurvez_geom', $multiCurveZ)
            ->executeStatement()
        ;
