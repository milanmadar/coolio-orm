...
class PolygonZ extends AbstractShapeZ
{
     ...
     * @return PointZ
     */
    public function getCenterPoint(): PointZ
    {
        ...
        if (abs($area) < 1e-9) {
            ...
            return new PointZ(($minX + $maxX) / 2, ($minY + $maxY) / 2, ($minZ + $maxZ) / 2);
        }
        ...
        return new PointZ($finalX, $finalY, $finalZ);
    }
